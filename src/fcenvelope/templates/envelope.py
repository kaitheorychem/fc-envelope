#!/usr/bin/env python3
"""Franck-Condon envelope F(E) -- figure script generated by fcenvelope.
...
def draw(ax, data: dict, *, label: str | None = LABEL, color: str = COLOR) -> None:
    ...
    energy = [e * X_SCALE for e in column(data["spectrum"], "energy")]
    density = [d / X_SCALE for d in column(data["spectrum"], "density")]
